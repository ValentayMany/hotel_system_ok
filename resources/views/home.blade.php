            ...
            <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ URL('images/image1.jpg') }}" class="d-block w-100" alt="Hotel View 1">
                    ...
                    <div class="carousel-item">
                        <img src="{{ URL('images/image2.jpg') }}" class="d-block w-100" alt="Hotel View 2">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ URL('images/image.jpg') }}" class="d-block w-100" alt="Hotel View 3">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ URL('images/image.jpg') }}" class="d-block w-100" alt="Hotel View 4">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ URL('images/image.jpg') }}" class="d-block w-100" alt="Hotel View 5">
                    </div>
                </div>
        ...
        <div class="main-content">
            <div class="left-section">
                ...
                <div class="carousel">
                    ...
                    <img src="{{ URL('images/roommain.jpg') }}" class="d-block w-100" alt="Main Room View">
                    {{--                     <span class="carousel-arrow next" style="color: #2563eb;" aria-label="Next slide">→</span> --}}
                </div>
                <div class="thumbnails">
                    <a href="#" class="thumbnail">
                        <img src="{{ URL('images/image.jpg') }}" alt="Room 1 Thumbnail">
                    </a>
                    <a href="#" class="thumbnail">
                        <img src="{{ URL('images/image.jpg') }}" alt="Room 2 Thumbnail">
                    </a>
                    <a href="#" class="thumbnail">
                        <img src="{{ URL('images/image.jpg') }}" alt="Room 3 Thumbnail">
                    </a>
                    <a href="#" class="thumbnail">
                        <img src="{{ URL('images/image.jpg') }}" alt="Room 4 Thumbnail">
                    </a>
                </div>
        ...
        <section id="roomDetails" class="mt-5">
            <div class="container">
                ...
                <div class="room-gallery">
                    <img src="{{ URL('images/image.jpg') }}" alt="Room 1" loading="lazy">
                    <img src="{{ URL('images/image.jpg') }}" alt="Room 2" loading="lazy">
                    <img src="{{ URL('images/image.jpg') }}" alt="Room 3" loading="lazy">
                    <img src="{{ URL('images/image.jpg') }}" alt="Room 4" loading="lazy">
                    <img src="{{ URL('images/image.jpg') }}" alt="Room 5" loading="lazy">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="promo-card">
                            <img src="{{ URL('images/promo1.jpg') }}" class="d-block w-100" alt="Promo 1">
                            <div class="promo-content">
                                <h5>ສົດຍອດກັບການຈອງຫ້ອງລົດ 20%</h5>
                    ...
                    <div class="col-md-4">
                        <div class="promo-card">
                            <img src="{{ URL('images/promo2.jpg') }}" class="d-block w-100" alt="Promo 2">
                            <div class="promo-content">
                                <h5>ພິເສດສຳລັບລູກຄ້າໃໝ່</h5>
                                <p>ສົດຍອດ 10% ສຳລັບລູກຄ້າໃໝ່ທີ່ຈອງຫ້ອງຄັ້ງທຳອິດ</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="promo-card">
                            <img src="{{ URL('images/promo3.jpg') }}" class="d-block w-100" alt="Promo 3">
                            <div class="promo-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="review-card">
                            <img src="{{ URL('images/teng.jpg') }}" alt="Customer" loading="lazy">
