                ...
                {{-- <a href="{{ /* route('admin/products')  */}}"> --}}
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open"
                            ...
                            <span class="text-[15px] ml-4 text-gray-200 font-bold">Book</span>
                        </button>
    
                        <!-- Dropdown Menu -->
                        <div x-show="open" @click.away="open = false" x-transition
                            class="absolute left-0 mt-2 bg-white rounded shadow-lg w-48 text-sm">
                            <ul>
                                <li><a class="block px-4 py-3 hover:bg-gray-200" href=" {{ route('Add_Room') }}  ">Add_Room</a></li>
                                <li><a class="block px-4 py-3 hover:bg-gray-200" href="#">Show_Room</a></li>
                                <li><a class="block px-4 py-3 hover:bg-gray-200" href="#"></a></li>
                            </ul>
                        </div>
                    </div>

                </a>
                <!-- Sidebar Item for Dropdown -->
